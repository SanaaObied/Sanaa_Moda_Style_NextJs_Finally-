...
export default function EnhancedNavbar() {
  ...
  const [wishlistCount, setWishlistCount] = useState(0) // Mock wishlist count
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (showSearchDropdown && !(event.target as Element).closest(".search-container")) {
        setShowSearchDropdown(false)
      }
    }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative search-container">
                <Input
                  ...
                  className="w-64 pl-10 hidden sm:block"
                />
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 hidden sm:block" />

                {showSearchDropdown && searchResults.length > 0 && (
                  <div className="absolute top-full left-0 right-0 bg-white border rounded-lg shadow-lg z-50 mt-1 max-h-80 overflow-y-auto">
                    ...
                    <Link
                      ...
                      className="block p-3 text-center text-rose-600 hover:bg-rose-50 border-t font-medium"
                      onClick={() => {
                        setShowSearchDropdown(false)
                        setSearchQuery("")
                      }}
              ...
              <Button
                variant="ghost"
                size="sm"
                className="text-gray-700 hover:text-rose-600 relative hidden sm:flex"
